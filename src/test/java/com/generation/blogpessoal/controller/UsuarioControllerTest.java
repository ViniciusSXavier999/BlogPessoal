...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		 ...
		 */
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Luva de pedreiro",
				"receba011@email.com.br", "12345", "https://i.imgur.com/JR7kUFU.jpg"));
	...
	public void naoDeveDuplicarUsuario() {
		 ...
		 */
		usuarioService.cadastrarUsuario(new Usuario(0L, "Maria da costa", "mariadasilva@email.com.br", "13465278",
		 ...
		 */
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Maria da costa",
				"mariadasilva@email.com.br", "13465278", "https://i.imgur.com/T12NIp9.jpg"));
	...
	public void deveAtualizarUmUsuario() {
		 ...
		 */
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario(0L, "vinicius xavier",
				"vini999@email.com.br", "vini123", "https://i.imgur.com/yDRVeK7.jpg"));
		/**
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(
				new Usuario(0L, "vini souza", "vini@gmail.com", "vini123", "https://i.imgur.com/5M2p5Wb.jpg"));

		usuarioService.cadastrarUsuario(
				new Usuario(0L, "lebron", "basquete@email.com.br", "lebron123", "https://i.imgur.com/Sk5SjWE.jpg"));
